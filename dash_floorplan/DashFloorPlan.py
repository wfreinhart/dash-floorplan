...
- image (string; required): Path to image file."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, label=Component.REQUIRED, value=Component.UNDEFINED, height=Component.REQUIRED, width=Component.REQUIRED, data=Component.UNDEFINED, image=Component.REQUIRED, **kwargs):
        self._prop_names = ['id', 'label', 'value', 'height', 'width', 'data', 'image']
        self._type = 'DashFloorPlan'
        self._namespace = 'dash_floorplan'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'label', 'value', 'height', 'width', 'data', 'image']
        ...
        for k in ['label', 'height', 'width', 'image']:
            if k not in args:
                raise TypeError(
