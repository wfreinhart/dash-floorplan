...
- update (boolean; required): Flag to trigger update from Dash.
...
- image (string; required): Path to image file."""
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, selection=Component.UNDEFINED, update=Component.REQUIRED, height=Component.REQUIRED, width=Component.REQUIRED, shapes=Component.REQUIRED, data=Component.REQUIRED, image=Component.REQUIRED, **kwargs):
        self._prop_names = ['id', 'selection', 'update', 'height', 'width', 'shapes', 'data', 'image']
        self._type = 'DashFloorPlan'
        self._namespace = 'dash_floorplan'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'selection', 'update', 'height', 'width', 'shapes', 'data', 'image']
        ...
        for k in ['id', 'update', 'height', 'width', 'shapes', 'data', 'image']:
            if k not in args:
                raise TypeError(
